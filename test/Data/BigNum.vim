...
function! s:suite.before()
  let s:BigNum = package#import('jp#Data#BigNum')
endfunction
...
function! s:suite.from_num() abort
  call s:assert.equals(s:BigNum.from_num(0), {'num': [0], 'sign': 1})
  call s:assert.equals(s:BigNum.from_num(123), {'num': [123], 'sign': 1})
  call s:assert.equals(s:BigNum.from_num(-789), {'num': [789], 'sign': -1})
...
function! s:suite.mul() abort
  " int32 * int32 -> int32
  call s:assert.equals(s:BigNum.mul(0, 0), s:BigNum.from_num(0))
...
function! s:suite.div() abort
  " int32 / int32
  call s:assert.equals(s:BigNum.div(123456780, 12345678), s:BigNum.from_num(10))
...
function! s:suite.mod() abort
  call s:assert.equals(s:BigNum.mod(3, -2), s:BigNum.from_num(1))
  call s:assert.equals(s:BigNum.mod(-3, 2), s:BigNum.from_num(-1))
  call s:assert.equals(s:BigNum.mod(-3, -2), s:BigNum.from_num(-1))
  call s:assert.equals(s:BigNum.mod(123456780, 12345678), s:BigNum.from_num(0))
  call s:assert.equals(s:BigNum.mod(123, 123), s:BigNum.from_num(0))
  call s:assert.equals(s:BigNum.mod('123456789', '123456790'), s:BigNum.from_num(123456789))
  call s:assert.equals(s:BigNum.mod('-1234567890123456789', '-1234567890123456790'), s:BigNum.from_string('-1234567890123456789'))
  call s:assert.equals(s:BigNum.mod('519920419074760465703', '-22801763489'), s:BigNum.from_num(0))
endfunction

function! s:suite.div_mod() abort
  call s:assert.equals(s:BigNum.div_mod('519920419074760465703', '22801763489'), [s:BigNum.from_string('22801763527'), s:BigNum.from_num(0)])
endfunction
...
function! s:suite.neg() abort
  call s:assert.equals(s:BigNum.neg(0), s:BigNum.from_num(0))
  call s:assert.equals(s:BigNum.neg(-1111), s:BigNum.from_num(1111))
